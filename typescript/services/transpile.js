 ...
 * - noCheck = true
 */
export function transpileModule(input, transpileOptions) {
 ...
 */
export function transpileDeclaration(input, transpileOptions) {
...
function transpileWorker(input, transpileOptions, declaration) {
    var _a;
    barebonesLibSourceFile !== null && barebonesLibSourceFile !== void 0 ? barebonesLibSourceFile : (barebonesLibSourceFile = createSourceFile(barebonesLibName, barebonesLibContent, { languageVersion: ScriptTarget.Latest }));
    const diagnostics = [];
    ...
    const sourceFile = createSourceFile(inputFileName, input, {
        ...
        jsDocParsingMode: (_a = transpileOptions.jsDocParsingMode) !== null && _a !== void 0 ? _a : JSDocParsingMode.ParseAll,
    });
 ...
 * @internal
 */
export function fixupCompilerOptions(options, diagnostics) {
    // Lazily create this value to fix module loading errors.
    commandLineOptionsStringToEnum = commandLineOptionsStringToEnum ||
        filter(optionDeclarations, o => typeof o.type === "object" && !forEachEntry(o.type, v => typeof v !== "number"));
