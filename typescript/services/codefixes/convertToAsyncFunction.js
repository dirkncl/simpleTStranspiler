...
function renameCollidingVarNames(nodeToRename, checker, synthNamesMap) {
    const identsToRenameMap = new Map(); // key is the symbol id
...
function isNullOrUndefined({ checker }, node) {
...
function transformCallbackArgument(func, hasContinuation, continuationArgName, inputArgName, parent, transformer) {
    ...
    switch (func.kind) {
        ...
        case SyntaxKind.ArrowFunction: {
            ...
            const returnType = (_a = getLastCallSignature(transformer.checker.getTypeAtLocation(func), transformer.checker)) === null || _a === void 0 ? void 0 : _a.getReturnType();
...
function getArgBindingName(funcNode, transformer) {
    ...
    function getSymbol(node) {
        var _a, _b;
        return (_b = (_a = tryCast(node, canHaveSymbol)) === null || _a === void 0 ? void 0 : _a.symbol) !== null && _b !== void 0 ? _b : transformer.checker.getSymbolAtLocation(node);
    }
...
function createSynthIdentifier(identifier, types = []) {
    return { kind: 0 /* SynthBindingNameKind.Identifier */, identifier, types, hasBeenDeclared: false, hasBeenReferenced: false };
}
function createSynthBindingPattern(bindingPattern, elements = emptyArray, types = []) {
    return { kind: 1 /* SynthBindingNameKind.BindingPattern */, bindingPattern, elements, types };
}
