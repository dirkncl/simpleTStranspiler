...
/** @internal */
export function formatOnEnter(position, sourceFile, formatContext) {
...
/** @internal */
export function formatOnSemicolon(position, sourceFile, formatContext) {
...
/** @internal */
export function formatOnOpeningCurly(position, sourceFile, formatContext) {
...
/** @internal */
export function formatOnClosingCurly(position, sourceFile, formatContext) {
...
/** @internal */
export function formatDocument(sourceFile, formatContext) {
    const span = {
        pos: 0,
...
/** @internal */
export function formatSelection(start, end, sourceFile, formatContext) {
...
function getOwnOrInheritedDelta(n, options, sourceFile) {
    let previousLine = -1 /* Constants.Unknown */;
    let child;
    while (n) {
...
/** @internal */
export function formatNodeGivenIndentation(node, sourceFileLike, languageVariant, initialIndentation, delta, formatContext) {
...
function formatSpanWorker(originalRange, enclosingNode, initialIndentation, delta, formattingScanner, { options, getRules, host }, requestKind, rangeContainsError, sourceFile) {
    ...
    let indentationOnLastIndentedLine = -1 /* Constants.Unknown */;
    const edits = [];
    ...
    if (previousRange && formattingScanner.getTokenFullStart() >= originalRange.end) {
        ...
        if (tokenInfo && tokenInfo.pos === previousRangeTriviaEnd) {
            ...
            const parent = ((_a = findPrecedingToken(tokenInfo.end, sourceFile, enclosingNode)) === null || _a === void 0 ? void 0 : _a.parent) || previousParent;
    ...
    function processNode(node, contextNode, nodeStartLine, undecoratedNodeStartLine, indentation, delta) {
        ...
        function processChildNode(child, inheritedIndentation, parent, parentDynamicIndentation, parentStartLine, undecoratedParentStartLine, isListItem, isFirstListItem) {
            ...
            let childIndentationAmount = -1 /* Constants.Unknown */;
            ...
            if (isFirstListItem && parent.kind === SyntaxKind.ArrayLiteralExpression && inheritedIndentation === -1 /* Constants.Unknown */) {
        ...
        function processChildNodes(nodes, parent, parentStartLine, parentDynamicIndentation) {
            ...
            let inheritedIndentation = -1 /* Constants.Unknown */;
        ...
        function consumeTokenAndAdvanceScanner(currentTokenInfo, parent, dynamicIndentation, container, isListEndToken) {
            ...
            let lineAction = 0 /* LineAction.None */;
                ...
                if (dynamicIndentation) {
                    switch (lineAction) {
                        ...
                        case 1 /* LineAction.LineAdded */:
                            ...
                            break;
                        default:
                            Debug.assert(lineAction === 0 /* LineAction.None */);
                    }
                }
 ...
 * @internal
 */
export function getRangeOfEnclosingComment(sourceFile, position, precedingToken, // eslint-disable-line no-restricted-syntax
...
/** @internal */
export function getIndentationString(indentation, options) {
