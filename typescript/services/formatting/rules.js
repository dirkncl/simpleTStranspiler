 ...
 */
function rule(debugName, left, right, context, action, flags = RuleFlags.None) {
...
function isNextTokenParentJsxAttribute(context) {
    return context.nextTokenParent.kind === SyntaxKind.JsxAttribute || (context.nextTokenParent.kind === SyntaxKind.JsxNamespacedName && context.nextTokenParent.parent.kind === SyntaxKind.JsxAttribute);
}
