 ...
 * @internal
 */
export function spanInSourceFileAtLocation(sourceFile, position) {
    ...
    function spanInNode(node) {
        if (node) {
            ...
            switch (node.kind) {
                ...
                case SyntaxKind.Decorator:
                    return spanInNodeArray(parent.modifiers, node, isDecorator);
        ...
        function spanInArrayLiteralOrObjectLiteralDestructuringPattern(node) {
            ...
            const elements = node.kind === SyntaxKind.ArrayLiteralExpression ? node.elements : node.properties;
