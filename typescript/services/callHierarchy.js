...
function getCallHierarchItemContainerName(node) {
    ...
    if (isAssignedExpression(node)) {
        if (isPropertyDeclaration(node.parent) && isClassLike(node.parent.parent)) {
            return isClassExpression(node.parent.parent) ? (_a = getAssignedName(node.parent.parent)) === null || _a === void 0 ? void 0 : _a.getText() : (_b = node.parent.parent.name) === null || _b === void 0 ? void 0 : _b.getText();
        }
    ...
    switch (node.kind) {
        ...
        case SyntaxKind.MethodDeclaration:
            if (node.parent.kind === SyntaxKind.ObjectLiteralExpression) {
                return (_c = getAssignedName(node.parent)) === null || _c === void 0 ? void 0 : _c.getText();
            }
            return (_d = getNameOfDeclaration(node.parent)) === null || _d === void 0 ? void 0 : _d.getText();
 ...
 * @internal
 */
export function resolveCallHierarchyDeclaration(program, location) {
 ...
 * @internal
 */
export function createCallHierarchyItem(program, node) {
    const sourceFile = node.getSourceFile();
 ...
 * @internal
 */
export function getIncomingCalls(program, declaration, cancellationToken) {
 ...
 * @internal
 */
export function getOutgoingCalls(program, declaration) {
