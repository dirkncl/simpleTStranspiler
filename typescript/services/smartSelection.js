    ...
    outer: while (true) {
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            if (positionShouldSnapToNode(sourceFile, pos, node)) {
                ...
                if (hasJSDocNodes(node) && ((_a = node.jsDoc) === null || _a === void 0 ? void 0 : _a.length)) {
                ...
                if (isSyntaxList(node)) {
                    ...
                    if (firstChild && hasJSDocNodes(firstChild) && ((_b = firstChild.jsDoc) === null || _b === void 0 ? void 0 : _b.length) && firstChild.getStart() !== node.pos) {
    ...
    function pushSelectionRange(start, end) {
        ...
        if (start !== end) {
            ...
            !textSpansEqual(textSpan, selectionRange.textSpan) &&
                ...
                selectionRange = Object.assign({ textSpan }, selectionRange && { parent: selectionRange });
            }
        }
    }
...
function getSelectionChildren(node) {
    ...
    if (isPropertySignature(node)) {
        ...
        const firstJSDocChild = ((_a = children[0]) === null || _a === void 0 ? void 0 : _a.kind) === SyntaxKind.JSDoc ? children[0] : undefined;
