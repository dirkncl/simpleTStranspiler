...
function getRefactorActionsToRemoveFunctionBraces(context) {
    ...
    if (context.preferences.provideRefactorNotApplicableReason) {
        return [{
                ...
                description: refactorDescription,
                actions: [
                    Object.assign(Object.assign({}, addBracesAction), { notApplicableReason: info.error }),
                    Object.assign(Object.assign({}, removeBracesAction), { notApplicableReason: info.error }),
                ],
            }];
    }
    return emptyArray;
