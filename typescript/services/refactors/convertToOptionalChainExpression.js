...
function getRefactorActionsToConvertToOptionalChain(context) {
    ...
    if (context.preferences.provideRefactorNotApplicableReason) {
        return [{
                name: refactorName,
                description: convertToOptionalChainExpressionMessage,
                actions: [Object.assign(Object.assign({}, toOptionalChainAction), { notApplicableReason: info.error })],
            }];
    }
    return emptyArray;
}
...
function getInfo(context, considerEmptySpans = true) {
...
function getExpression(node) {
    ...
    if (isVariableStatement(node)) {
        ...
        const initializer = variable === null || variable === void 0 ? void 0 : variable.initializer;
...
function convertOccurrences(checker, toConvert, occurrences) {
    if (isPropertyAccessExpression(toConvert) || isElementAccessExpression(toConvert) || isCallExpression(toConvert)) {
        ...
        const isOccurrence = (lastOccurrence === null || lastOccurrence === void 0 ? void 0 : lastOccurrence.getText()) === toConvert.expression.getText();
        if (isOccurrence)
            occurrences.pop();
