            ...
            return [
                {
                    ...
                    description: getLocaleSpecificMessage(Diagnostics.Convert_default_export_to_named_export),
                    actions: [
                        Object.assign(Object.assign({}, defaultToNamedAction), { notApplicableReason: info.error }),
                        Object.assign(Object.assign({}, namedToDefaultAction), { notApplicableReason: info.error }),
                    ],
                },
            ];
        }
...
function getInfo(context, considerPartialSpans = true) {
    ...
    const noSymbolError = (id) => (isIdentifier(id) && checker.getSymbolAtLocation(id)) ? undefined
    ...
    switch (exportNode.kind) {
        ...
        case SyntaxKind.VariableStatement: {
            ...
            return noSymbolError(decl.name)
                || { exportNode: vs, exportName: decl.name, wasDefault, exportingModuleSymbol };
        }
        case SyntaxKind.ExportAssignment: {
            ...
            return noSymbolError(node.expression)
                || { exportNode: node, exportName: node.expression, wasDefault, exportingModuleSymbol };
        }
        default:
            return undefined;
    }
...
function changeNamedToDefaultImport(importingSourceFile, ref, changes) {
    ...
    switch (parent.kind) {
        ...
        default:
            Debug.assertNever(parent, `Unexpected parent kind ${parent.kind}`);
    }
}
...
function getExportingModuleSymbol(parent, checker) {
