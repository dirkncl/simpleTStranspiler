...
const noRegexTable = arrayToNumericMap([
...
/** @internal */
export function getSemanticClassifications(typeChecker, cancellationToken, sourceFile, classifiableNames, span) {
...
/** @internal */
export function getEncodedSemanticClassifications(typeChecker, cancellationToken, sourceFile, classifiableNames, span) {
    const spans = [];
...
/** @internal */
export function getSyntacticClassifications(cancellationToken, sourceFile, span) {
    return convertClassificationsToSpans(getEncodedSyntacticClassifications(cancellationToken, sourceFile, span));
}
/** @internal */
export function getEncodedSyntacticClassifications(cancellationToken, sourceFile, span) {
            ...
            for (const tag of docComment.tags) {
                ...
                switch (tag.kind) {
                    ...
                    case SyntaxKind.JSDocTypedefTag:
                        const type = tag;
                        commentStart = ((_c = type.typeExpression) === null || _c === void 0 ? void 0 : _c.kind) === SyntaxKind.JSDocTypeExpression && ((_d = type.fullName) === null || _d === void 0 ? void 0 : _d.end) || ((_e = type.typeExpression) === null || _e === void 0 ? void 0 : _e.end) || commentStart;
                        break;
                    ...
                    case SyntaxKind.JSDocThrowsTag:
                        processElement(tag.typeExpression);
                        pos = tag.end;
                        commentStart = ((_h = tag.typeExpression) === null || _h === void 0 ? void 0 : _h.end) || commentStart;
                        break;
                }
