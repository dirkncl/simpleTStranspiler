...
(function (DocumentHighlights) {
    ...
    function getHighlightSpans(node, sourceFile) {
        ...
        function getFromAllDeclarations(nodeTest, keywords) {
            return useParent(node.parent, nodeTest, decl => { var _a; return mapDefined((_a = tryCast(decl, canHaveSymbol)) === null || _a === void 0 ? void 0 : _a.symbol.declarations, d => nodeTest(d) ? find(d.getChildren(sourceFile), c => contains(keywords, c.kind)) : undefined); });
        }
