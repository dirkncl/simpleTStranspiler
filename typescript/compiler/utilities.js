...
/** @internal */
export function getDeclarationOfKind(symbol, kind) {
...
/** @internal */
export function getDeclarationsOfKind(symbol, kind) {
...
/** @internal */
export function isTransientSymbol(symbol) {
...
export function isExternalModuleSymbol(moduleSymbol) {
    return !!(moduleSymbol.flags & SymbolFlags.Module) && moduleSymbol.escapedName.charCodeAt(0) === CharacterCodes.doubleQuote;
}
...
/** @internal */
export function changesAffectModuleResolution(oldOptions, newOptions) {
...
/** @internal */
export function changesAffectingProgramStructure(oldOptions, newOptions) {
    return optionsHaveChanges(oldOptions, newOptions, optionsAffectingProgramStructure);
}
/** @internal */
export function optionsHaveChanges(oldOptions, newOptions, optionDeclarations) {
...
/** @internal */
export function forEachAncestor(node, callback) {
    while (true) {
 ...
 * @internal
 */
export function forEachEntry(map, callback) {
 ...
 * @internal
 */
export function forEachKey(map, callback) {
 ...
 * @internal
 */
export function copyEntries(source, target) {
    source.forEach((value, key) => {
        target.set(key, value);
    });
}
/** @internal */
export function usingSingleLineStringWriter(action) {
...
/** @internal */
export function getFullWidth(node) {
    return node.end - node.pos;
}
/** @internal */
export function projectReferenceIsEqualTo(oldRef, newRef) {
    return oldRef.path === newRef.path &&
        !oldRef.prepend === !newRef.prepend &&
        !oldRef.circular === !newRef.circular;
}
/** @internal */
export function moduleResolutionIsEqualTo(oldResolution, newResolution) {
...
/** @internal */
export function getResolvedModuleFromResolution(resolution) {
    return resolution.resolvedModule;
}
/** @internal */
export function getResolvedTypeReferenceDirectiveFromResolution(resolution) {
    return resolution.resolvedTypeReferenceDirective;
}
/** @internal */
export function createModuleNotFoundChain(sourceFile, host, moduleReference, mode, packageName) {
    var _a;
    const alternateResult = (_a = host.getResolvedModule(sourceFile, moduleReference, mode)) === null || _a === void 0 ? void 0 : _a.alternateResult;
    const alternateResultMessage = alternateResult && (getEmitModuleResolutionKind(host.getCompilerOptions()) === ModuleResolutionKind.Node10
        ? [Diagnostics.There_are_types_at_0_but_this_result_could_not_be_resolved_under_your_current_moduleResolution_setting_Consider_updating_to_node16_nodenext_or_bundler, [alternateResult]]
        : [
    ...
    const result = alternateResultMessage
        ...
        /*details*/ undefined, alternateResultMessage[0], ...alternateResultMessage[1])
        : host.typesPackageExists(packageName)
            ? chainDiagnosticMessages(
            /*details*/ undefined, Diagnostics.If_the_0_package_actually_exposes_this_module_consider_sending_a_pull_request_to_amend_https_Colon_Slash_Slashgithub_com_SlashDefinitelyTyped_SlashDefinitelyTyped_Slashtree_Slashmaster_Slashtypes_Slash_1, packageName, mangleScopedPackageName(packageName))
            : host.packageBundlesTypes(packageName)
                ? chainDiagnosticMessages(
                /*details*/ undefined, Diagnostics.If_the_0_package_actually_exposes_this_module_try_adding_a_new_declaration_d_ts_file_containing_declare_module_1, packageName, moduleReference)
                : chainDiagnosticMessages(
                /*details*/ undefined, Diagnostics.Try_npm_i_save_dev_types_Slash_1_if_it_exists_or_add_a_new_declaration_d_ts_file_containing_declare_module_0, moduleReference, mangleScopedPackageName(packageName));
    if (result)
...
export function createModeMismatchDetails(currentSourceFile) {
    ...
    const result = scope && !scope.contents.packageJsonContent.type ?
        targetExt ?
            chainDiagnosticMessages(
            /*details*/ undefined, Diagnostics.To_convert_this_file_to_an_ECMAScript_module_change_its_file_extension_to_0_or_add_the_field_type_Colon_module_to_1, targetExt, combinePaths(scope.packageDirectory, "package.json")) :
            chainDiagnosticMessages(
            /*details*/ undefined, Diagnostics.To_convert_this_file_to_an_ECMAScript_module_add_the_field_type_Colon_module_to_0, combinePaths(scope.packageDirectory, "package.json")) :
        targetExt ?
            chainDiagnosticMessages(
            /*details*/ undefined, Diagnostics.To_convert_this_file_to_an_ECMAScript_module_change_its_file_extension_to_0_or_create_a_local_package_json_file_with_type_Colon_module, targetExt) :
            chainDiagnosticMessages(
            /*details*/ undefined, Diagnostics.To_convert_this_file_to_an_ECMAScript_module_create_a_local_package_json_file_with_type_Colon_module);
...
/** @internal */
export function packageIdToPackageName({ name, subModuleName }) {
    return subModuleName ? `${name}/${subModuleName}` : name;
}
/** @internal */
export function packageIdToString(packageId) {
    var _a;
    return `${packageIdToPackageName(packageId)}@${packageId.version}${(_a = packageId.peerDependencies) !== null && _a !== void 0 ? _a : ""}`;
}
/** @internal */
export function typeDirectiveIsEqualTo(oldResolution, newResolution) {
    return oldResolution === newResolution ||
...
/** @internal */
export function hasChangesInResolutions(names, newResolutions, getOldResolution, comparer) {
...
/** @internal */
export function containsParseError(node) {
...
/** @internal */
export function getSourceFileOfModule(module) {
...
/** @internal */
export function isStatementWithLocals(node) {
    switch (node.kind) {
...
/** @internal */
export function getStartPositionOfLine(line, sourceFile) {
    Debug.assert(line >= 0);
    return getLineStarts(sourceFile)[line];
}
// This is a useful function for debugging purposes.
/** @internal @knipignore */
export function nodePosToString(node) {
    const file = getSourceFileOfNode(node);
    const loc = getLineAndCharacterOfPosition(file, node.pos);
    return `${file.fileName}(${loc.line + 1},${loc.character + 1})`;
}
/** @internal */
export function getEndLinePosition(line, sourceFile) {
    Debug.assert(line >= 0);
 ...
 * @internal
 */
export function isGrammarError(parent, child) {
 ...
 * @internal
 */
export function insertStatementsAfterStandardPrologue(to, from) {
    return insertStatementsAfterPrologue(to, from, isPrologueDirective);
}
/** @internal */
export function insertStatementsAfterCustomPrologue(to, from) {
 ...
 * @knipignore
 */
export function insertStatementAfterStandardPrologue(to, statement) {
    return insertStatementAfterPrologue(to, statement, isPrologueDirective);
}
/** @internal */
export function insertStatementAfterCustomPrologue(to, statement) {
 ...
 * @internal
 */
export function isRecognizedTripleSlashComment(text, commentPos, commentEnd) {
...
/** @internal */
export function isPinnedComment(text, start) {
    return text.charCodeAt(start + 1) === CharacterCodes.asterisk &&
        text.charCodeAt(start + 2) === CharacterCodes.exclamation;
}
/** @internal */
export function createCommentDirectivesMap(sourceFile, commentDirectives) {
...
export function getTokenPosOfNode(node, sourceFile, includeJsDoc) {
    ...
    if (isJSDocNode(node) || node.kind === SyntaxKind.JsxText) {
        ...
        return skipTrivia((sourceFile !== null && sourceFile !== void 0 ? sourceFile : getSourceFileOfNode(node)).text, node.pos, /*stopAfterLineBreak*/ false, /*stopAtComments*/ true);
    }
    ...
    return skipTrivia((sourceFile !== null && sourceFile !== void 0 ? sourceFile : getSourceFileOfNode(node)).text, node.pos, 
    /*stopAfterLineBreak*/ false, 
    /*stopAtComments*/ false, isInJSDoc(node));
}
/** @internal */
export function getNonDecoratorTokenPosOfNode(node, sourceFile) {
...
/** @internal */
export function getNonModifierTokenPosOfNode(node, sourceFile) {
...
/** @internal */
export function getSourceTextOfNodeFromSourceFile(sourceFile, node, includeTrivia = false) {
...
/** @internal */
export function moduleExportNameTextUnescaped(node) {
    return node.kind === SyntaxKind.StringLiteral ? node.text : unescapeLeadingUnderscores(node.escapedText);
}
/** @internal */
export function moduleExportNameTextEscaped(node) {
...
/** @internal */
export function getTextOfNodeFromSourceText(sourceText, node, includeTrivia = false) {
    if (nodeIsMissing(node)) {
        return "";
    }
...
/** @internal */
export function getTextOfNode(node, includeTrivia = false) {
 ...
 * @internal
 */
export function indexOfNode(nodeArray, node) {
 ...
 * @internal
 */
export function getEmitFlags(node) {
 ...
 * @internal
 */
export function getInternalEmitFlags(node) {
    const emitNode = node.emitNode;
...
/** @internal */
export var GetLiteralTextFlags;
...
export function getLiteralText(node, sourceFile, flags) {
    ...
    switch (node.kind) {
        case SyntaxKind.StringLiteral: {
            const escapeText = flags & 2 /* GetLiteralTextFlags.JsxAttributeEscape */ ? escapeJsxAttributeString :
                flags & 1 /* GetLiteralTextFlags.NeverAsciiEscape */ || (getEmitFlags(node) & EmitFlags.NoAsciiEscaping) ? escapeString :
        ...
        case SyntaxKind.TemplateTail: {
            ...
            const escapeText = flags & 1 /* GetLiteralTextFlags.NeverAsciiEscape */ || (getEmitFlags(node) & EmitFlags.NoAsciiEscaping) ? escapeString :
                escapeNonAsciiString;
            const rawText = (_a = node.rawText) !== null && _a !== void 0 ? _a : escapeTemplateSubstitution(escapeText(node.text, CharacterCodes.backtick));
            switch (node.kind) {
                case SyntaxKind.NoSubstitutionTemplateLiteral:
                    return "`" + rawText + "`";
                case SyntaxKind.TemplateHead:
...
/** @internal */
export function getTextOfConstantValue(value) {
...
/** @internal */
export function isNonGlobalAmbientModule(node) {
...
/** @internal */
export function isBlockScopedContainerTopLevel(node) {
...
/** @internal */
export function getNonAugmentationDeclaration(symbol) {
    var _a;
    return (_a = symbol.declarations) === null || _a === void 0 ? void 0 : _a.find(d => !isExternalModuleAugmentation(d) && !(isModuleDeclaration(d) && isGlobalScopeAugmentation(d)));
}
 ...
 * @internal
 */
export function isEffectiveStrictModeSourceFile(node, compilerOptions) {
...
/** @internal */
export function isAmbientPropertyDeclaration(node) {
...
/** @internal */
export function isDeclarationWithTypeParameters(node) {
    Debug.type(node);
    switch (node.kind) {
...
/** @internal */
export function isDeclarationWithTypeParameterChildren(node) {
    Debug.type(node);
    switch (node.kind) {
...
/** @internal */
export function isAnyImportOrBareOrAccessedRequire(node) {
    return isAnyImportSyntax(node) || isVariableDeclarationInitializedToBareOrAccessedRequire(node);
}
/** @internal */
export function isAnyImportOrRequireStatement(node) {
...
/** @internal */
export function hasPossibleExternalModuleReference(node) {
...
/** @internal */
export function forEachEnclosingBlockScopeContainer(node, cb) {
...
/** @internal */
export function createDiagnosticForNodeArray(sourceFile, nodes, message, ...args) {
...
/** @internal */
export function createDiagnosticForNodeFromMessageChain(sourceFile, node, messageChain, relatedInformation) {
    const span = getErrorSpanForNode(sourceFile, node);
    return createFileDiagnosticFromMessageChain(sourceFile, span.start, span.length, messageChain, relatedInformation);
}
/** @internal */
export function createDiagnosticForNodeArrayFromMessageChain(sourceFile, nodes, messageChain, relatedInformation) {
    const start = skipTrivia(sourceFile.text, nodes.pos);
    return createFileDiagnosticFromMessageChain(sourceFile, start, nodes.end - start, messageChain, relatedInformation);
}
function assertDiagnosticLocation(sourceText, start, length) {
...
/** @internal */
export function createFileDiagnosticFromMessageChain(file, start, length, messageChain, relatedInformation) {
...
/** @internal */
export function createDiagnosticForFileFromMessageChain(sourceFile, messageChain, relatedInformation) {
    return {
        file: sourceFile,
        start: 0,
        length: 0,
...
/** @internal */
export function createDiagnosticMessageChainFromDiagnostic(diagnostic) {
...
/** @internal */
export function createDiagnosticForRange(sourceFile, range, message) {
    return {
        file: sourceFile,
        start: range.pos,
...
/** @internal */
export function getCanonicalDiagnostic(message, ...args) {
    return {
        code: message.code,
...
/** @internal */
export function getSpanOfTokenAtPosition(sourceFile, pos) {
...
/** @internal */
export function getErrorSpanForNode(sourceFile, node) {
    let errorNode = node;
    switch (node.kind) {
        case SyntaxKind.SourceFile: {
...
/** @internal */
export function isCustomPrologue(node) {
    return !!(getEmitFlags(node) & EmitFlags.CustomPrologue);
}
/** @internal */
export function isHoistedFunction(node) {
...
/** @internal */
export function isHoistedVariableStatement(node) {
    return isCustomPrologue(node)
        && isVariableStatement(node)
        && every(node.declarationList.declarations, isHoistedVariable);
}
/** @internal */
export function getLeadingCommentRangesOfNode(node, sourceFileOfNode) {
...
/** @internal */
export function isCommonJsExportedExpression(node) {
    if (!isInJSFile(node))
        return false;
...
/** @internal */
export function isCommonJsExportPropertyAssignment(node) {
    if (!isInJSFile(node))
        return false;
...
/** @internal */
export function unwrapInnermostStatementOfLabel(node, beforeUnwrapLabelCallback) {
    while (true) {
...
/** @internal */
export function isIdentifierTypePredicate(predicate) {
    return predicate && predicate.kind === TypePredicateKind.Identifier;
}
/** @internal */
export function isThisTypePredicate(predicate) {
    return predicate && predicate.kind === TypePredicateKind.This;
}
/** @internal */
export function forEachPropertyAssignment(objectLiteral, key, callback, key2) {
    return forEach(objectLiteral === null || objectLiteral === void 0 ? void 0 : objectLiteral.properties, property => {
...
export function getTsConfigPropArrayElementValue(tsConfigSourceFile, propKey, elementValue) {
    return forEachTsConfigPropArray(tsConfigSourceFile, propKey, property => isArrayLiteralExpression(property.initializer) ?
        find(property.initializer.elements, (element) => isStringLiteral(element) && element.text === elementValue) :
        undefined);
}
/** @internal */
...
/** @internal */
export function getContainingFunctionDeclaration(node) {
...
/** @internal */
export function getContainingClassStaticBlock(node) {
...
export function getContainingClassExcludingClassDecorators(node) {
    ...
    return decorator && isClassLike(decorator.parent) ? getContainingClass(decorator.parent) : getContainingClass(decorator !== null && decorator !== void 0 ? decorator : node);
}
 ...
 * @internal
 */
export function isThisContainerOrFunctionBlock(node) {
    switch (node.kind) {
...
/** @internal */
export function getImmediatelyInvokedFunctionExpression(func) {
...
export function isThisInitializedDeclaration(node) {
    var _a;
    return !!node && isVariableDeclaration(node) && ((_a = node.initializer) === null || _a === void 0 ? void 0 : _a.kind) === SyntaxKind.ThisKeyword;
}
/** @internal */
...
/** @internal */
export function isEmptyStringLiteral(node) {
...
/** @internal */
export function isFullSourceFile(sourceFile) {
    return (sourceFile === null || sourceFile === void 0 ? void 0 : sourceFile.kind) === SyntaxKind.SourceFile;
}
/** @internal */
...
/** @internal */
export function isInJSDoc(node) {
...
/** @internal */
export function isRequireCall(callExpression, requireStringLiteralLikeArgument) {
...
/** @internal */
export function isBindingElementOfBareOrAccessedRequire(node) {
...
/** @internal */
export function isSingleOrDoubleQuote(charCode) {
    return charCode === CharacterCodes.singleQuote || charCode === CharacterCodes.doubleQuote;
}
/** @internal */
export function isStringDoubleQuoted(str, sourceFile) {
 ...
 * @internal
 */
export function getEffectiveInitializer(node) {
 ...
 * @internal
 */
export function getDeclaredExpandoInitializer(node) {
 ...
 * @internal
 */
export function getAssignedExpandoInitializer(node) {
 ...
 * @internal
 */
export function getExpandoInitializer(initializer, isPrototypeAssignment) {
...
/** @internal */
export function isDefaultedExpandoInitializer(node) {
 ...
 * @internal
 */
export function getNameOfExpando(node) {
 ...
 * @internal
 */
export function isSameEntityName(name, initializer) {
...
/** @internal */
export function getNameOrArgument(expr) {
 ...
 * @internal
 */
export function getElementOrPropertyAccessArgumentExpressionOrName(node) {
...
/** @internal */
export function getAssignmentDeclarationPropertyAccessKind(lhs) {
...
/** @internal */
export function setValueDeclaration(symbol, node) {
...
export function tryGetModuleSpecifierFromDeclaration(node) {
    ...
    switch (node.kind) {
        case SyntaxKind.VariableDeclaration:
        case SyntaxKind.BindingElement:
            return (_a = findAncestor(node.initializer, (node) => isRequireCall(node, /*requireStringLiteralLikeArgument*/ true))) === null || _a === void 0 ? void 0 : _a.arguments[0];
        case SyntaxKind.ImportDeclaration:
        case SyntaxKind.ExportDeclaration:
        case SyntaxKind.JSDocImportTag:
            return tryCast(node.moduleSpecifier, isStringLiteralLike);
        case SyntaxKind.ImportEqualsDeclaration:
            return tryCast((_b = tryCast(node.moduleReference, isExternalModuleReference)) === null || _b === void 0 ? void 0 : _b.expression, isStringLiteralLike);
        case SyntaxKind.ImportClause:
        case SyntaxKind.NamespaceExport:
...
/** @internal */
export function forEachImportClauseDeclaration(node, action) {
    if (node.name) {
...
/** @internal */
export function isJSDocTypeAlias(node) {
...
/** @internal */
export function canHaveJSDoc(node) {
    switch (node.kind) {
        case SyntaxKind.ArrowFunction:
        case SyntaxKind.BinaryExpression:
        case SyntaxKind.Block:
...
export function getJSDocCommentsAndTags(hostNode, noCache) {
    let result;
...
/** @internal */
export function getEffectiveContainerForJSDocTemplateTag(node) {
...
/** @internal */
export function getJSDocOverloadTags(node) {
...
/** @internal */
export function getEffectiveJSDocHost(node) {
...
export function getAssignmentTargetKind(node) {
    ...
    switch (target.kind) {
        ...
        case SyntaxKind.PrefixUnaryExpression:
        case SyntaxKind.PostfixUnaryExpression:
            return 2 /* AssignmentKind.Compound */;
        case SyntaxKind.ForInStatement:
        case SyntaxKind.ForOfStatement:
            return 1 /* AssignmentKind.Definite */;
    }
}
 ...
 * @internal
 */
export function walkUpParenthesizedTypesAndGetParentAndChild(node) {
    let child;
...
/** @internal */
export function skipParentheses(node, excludeJSDocTypeAssertions) {
...
/** @internal */
export function isAliasableExpression(e) {
    return isEntityNameExpression(e) || isClassExpression(e);
}
/** @internal */
export function exportAssignmentIsAlias(node) {
    const e = getExportAssignmentExpression(node);
    return isAliasableExpression(e);
}
/** @internal */
export function getExportAssignmentExpression(node) {
    return isExportAssignment(node) ? node.expression : node.right;
}
/** @internal */
export function getPropertyAssignmentAliasLikeExpression(node) {
...
/** @internal */
export function getEffectiveImplementsTypeNodes(node) {
    if (isInJSFile(node)) {
 ...
 * @internal
 */
export function getAllSuperTypeNodes(node) {
...
/** @internal */
export function getInterfaceBaseTypeNodes(node) {
    const heritageClause = getHeritageClause(node.heritageClauses, SyntaxKind.ExtendsKeyword);
    return heritageClause ? heritageClause.types : undefined;
}
/** @internal */
export function getHeritageClause(clauses, kind) {
    if (clauses) {
...
/** @internal */
export function getAncestor(node, kind) {
    while (node) {
        if (node.kind === kind) {
            return node;
        }
...
/** @internal */
export function isStringANonContextualKeyword(name) {
    const token = stringToToken(name);
    return token !== undefined && isNonContextualKeyword(token);
}
/** @internal */
export function isIdentifierANonContextualKeyword(node) {
...
/** @internal */
export function getEscapedTextOfIdentifierOrLiteral(node) {
...
/** @internal */
export function isPrivateIdentifierSymbol(symbol) {
    return startsWith(symbol.escapedName, "__#");
}
/**
...
/** @internal */
export function isNamedEvaluation(node, cb) {
...
/** @internal */
export function nodeIsSynthesized(range) {
...
/** @internal */
export function getExpressionAssociativity(expression) {
    const operator = getOperator(expression);
    const hasArguments = expression.kind === SyntaxKind.NewExpression && expression.arguments !== undefined;
    return getOperatorAssociativity(expression.kind, operator, hasArguments);
}
/** @internal */
export function getOperatorAssociativity(kind, operator, hasArguments) {
    switch (kind) {
        case SyntaxKind.NewExpression:
...
/** @internal */
export function getOperatorPrecedence(nodeKind, operatorKind, hasArguments) {
    switch (nodeKind) {
...
/** @internal */
export function escapeTemplateSubstitution(str) {
...
export function isIntrinsicJsxName(name) {
    ...
    return (ch >= CharacterCodes.a && ch <= CharacterCodes.z) || name.includes("-");
}
const indentStrings = ["", "    "];
/** @internal */
export function getIndentString(level) {
    // prepopulate cache
...
/** @internal */
export function createTextWriter(newLine) {
    // Why var? It avoids TDZ checks in the runtime which can be costly.
    // See: https://github.com/microsoft/TypeScript/issues/52924
    /* eslint-disable no-var */
    var output;
...
export function getTrailingSemicolonDeferringWriter(writer) {
    ...
    return Object.assign(Object.assign({}, writer), { writeTrailingSemicolon() {
...
/** @internal */
export function getResolvedExternalModuleName(host, file, referenceFile) {
...
/** @internal */
export function getExternalModuleNameFromDeclaration(host, resolver, declaration) {
...
/** @internal */
export function getOwnEmitOutputFilePath(fileName, host, extension) {
...
/** @internal */
export function getDeclarationEmitOutputFilePath(fileName, host) {
    return getDeclarationEmitOutputFilePathWorker(fileName, host.getCompilerOptions(), host);
}
/** @internal */
export function getDeclarationEmitOutputFilePathWorker(fileName, options, host) {
...
/** @internal */
export function getPossibleOriginalInputPathWithoutChangingExt(filePath, ignoreCase, outputDir, getCommonSourceDirectory) {
    return outputDir ?
        resolvePath(getCommonSourceDirectory(), getRelativePathFromDirectory(outputDir, filePath, ignoreCase)) :
        filePath;
}
/**
 ...
 * @internal
 */
export function getPathsBasePath(options, host) {
    var _a, _b;
    if (!options.paths)
        return undefined;
    return (_a = options.baseUrl) !== null && _a !== void 0 ? _a : Debug.checkDefined(options.pathsBasePath || ((_b = host.getCurrentDirectory) === null || _b === void 0 ? void 0 : _b.call(host)), "Encountered 'paths' without a 'baseUrl', config file, or host 'getCurrentDirectory'.");
}
/**
...
/** @internal */
export function getSourceFilePathInNewDir(fileName, host, newDirPath) {
...
/** @internal */
export function writeFile(host, diagnostics, fileName, text, writeByteOrderMark, sourceFiles, data) {
...
/** @internal */
export function writeFileEnsuringDirectories(path, data, writeByteOrderMark, writeFile, createDirectory, directoryExists) {
...
/** @internal */
export function getLineOfLocalPosition(sourceFile, pos) {
    const lineStarts = getLineStarts(sourceFile);
 ...
 * @internal
 */
export function getSetAccessorTypeAnnotationNode(accessor) {
...
/** @internal */
export function parameterIsThisKeyword(parameter) {
...
/** @internal */
export function identifierIsThisKeyword(id) {
    return id.escapedText === "this";
}
/** @internal */
export function getAllAccessorDeclarations(declarations, accessor) {
    // TODO: GH#18217
    let firstAccessor;
    let secondAccessor;
    let getAccessor;
 ...
 * @internal
 */
export function getEffectiveTypeAnnotationNode(node) {
    if (!isInJSFile(node) && isFunctionDeclaration(node))
        return undefined;
    if (isTypeAliasDeclaration(node))
        return undefined; // has a .type, is not a type annotation
 ...
 * @internal
 */
export function getEffectiveReturnTypeNode(node) {
    return isJSDocSignature(node) ?
        node.type && node.type.typeExpression && node.type.typeExpression.type :
        node.type || (isInJSFile(node) ? getJSDocReturnType(node) : undefined);
}
/** @internal */
export function getJSDocTypeParameterDeclarations(node) {
...
/** @internal */
export function emitNewLineBeforeLeadingCommentOfPosition(lineMap, writer, pos, commentPos) {
    // If the leading comments start on different line than the start of node, write new line
    if (pos !== commentPos &&
 ...
 * @internal
 */
export function emitDetachedComments(text, lineMap, writer, writeComment, node, newLine, removeComments) {
    let leadingComments;
...
/** @internal */
export function writeCommentRange(text, lineMap, writer, commentPos, commentEnd, newLine) {
...
/** @internal */
export function hasEffectiveModifiers(node) {
    return getEffectiveModifierFlags(node) !== ModifierFlags.None;
}
/** @internal */
export function hasSyntacticModifiers(node) {
    return getSyntacticModifierFlags(node) !== ModifierFlags.None;
}
/** @internal */
export function hasEffectiveModifier(node, flags) {
...
/** @internal */
export function hasEffectiveReadonlyModifier(node) {
...
/** @internal */
export function getSelectedEffectiveModifierFlags(node, flags) {
    return getEffectiveModifierFlags(node) & flags;
}
/** @internal @knipignore */
export function getSelectedSyntacticModifierFlags(node, flags) {
 ...
 * @internal
 */
export function getEffectiveModifierFlags(node) {
    return getModifierFlagsWorker(node, /*includeJSDoc*/ true);
}
/** @internal */
export function getEffectiveModifierFlagsAlwaysIncludeJSDoc(node) {
 ...
 * @internal
 */
export function getSyntacticModifierFlags(node) {
    ...
    if (!!node.parent && !isParameter(node)) {
        if (isInJSFile(node)) {
            if (getJSDocPublicTagNoCache(node))
                flags |= ModifierFlags.JSDocPublic;
            if (getJSDocPrivateTagNoCache(node))
                flags |= ModifierFlags.JSDocPrivate;
            if (getJSDocProtectedTagNoCache(node))
                flags |= ModifierFlags.JSDocProtected;
            if (getJSDocReadonlyTagNoCache(node))
                flags |= ModifierFlags.JSDocReadonly;
            if (getJSDocOverrideTagNoCache(node))
                flags |= ModifierFlags.JSDocOverride;
        }
 ...
 * @internal
 */
export function getEffectiveModifierFlagsNoCache(node) {
 ...
 * @knipignore
 */
export function getSyntacticModifierFlagsNoCache(node) {
...
/** @internal */
export function isBinaryLogicalOperator(token) {
...
/** @internal */
export function isLogicalOrCoalescingAssignmentOperator(token) {
...
/** @internal */
export function isPropertyAccessEntityNameExpression(node) {
...
export function isRightSideOfQualifiedNameOrPropertyAccess(node) {
    return (node.parent.kind === SyntaxKind.QualifiedName && node.parent.right === node) ||
        ...
        (node.parent.kind === SyntaxKind.MetaProperty && node.parent.name === node);
}
/** @internal */
...
/** @internal */
export function isRightSideOfQualifiedNameOrPropertyAccessOrJSDocMemberName(node) {
...
/** @internal */
export function isRightSideOfInstanceofExpression(node) {
...
/** @internal */
export function getLocalSymbolForExportDefault(symbol) {
...
/** @internal */
export function base64encode(host, input) {
...
/** @internal */
export function base64decode(host, input) {
...
/** @internal */
export function readJsonOrUndefined(path, hostOrText) {
...
/** @internal */
export function readJson(path, host) {
...
/** @internal */
export function directoryProbablyExists(directoryName, host) {
...
const lineFeed = "\n";
/** @internal */
export function getNewLineCharacter(options) {
 ...
 * @internal
 */
export function createRange(pos, end = pos) {
 ...
 * @internal
 */
export function moveRangeEnd(range, end) {
 ...
 * @internal
 */
export function moveRangePos(range, pos) {
 ...
 * @internal
 */
export function createTokenRange(pos, token) {
    return createRange(pos, pos + tokenToString(token).length);
}
/** @internal */
export function rangeIsOnSingleLine(range, sourceFile) {
...
/** @internal @knipignore */
export function getLinesBetweenRangeEndPositions(range1, range2, sourceFile) {
    return getLinesBetweenPositions(sourceFile, range1.end, range2.end);
}
/** @internal */
export function isNodeArrayMultiLine(list, sourceFile) {
...
/** @internal @knipignore */
export function getStartPositionOfRange(range, sourceFile, includeComments) {
...
export function getLinesBetweenPositionAndPrecedingNonWhitespaceCharacter(pos, stopPos, sourceFile, includeComments) {
    ...
    return getLinesBetweenPositions(sourceFile, prevPos !== null && prevPos !== void 0 ? prevPos : stopPos, startPos);
}
/** @internal */
...
/** @internal */
export function rangeContainsRange(r1, r2) {
    return startEndContainsRange(r1.pos, r1.end, r2);
}
/** @internal */
export function startEndContainsRange(start, end, range) {
 ...
 * @internal
 */
export function isDeclarationNameOfEnumOrNamespace(node) {
...
/** @internal */
export function getInitializedVariables(node) {
    return filter(node.declarations, isInitializedVariable);
}
/** @internal */
export function isInitializedVariable(node) {
    return isVariableDeclaration(node) && node.initializer !== undefined;
}
/** @internal */
export function isWatchSet(options) {
    // Firefox has Object.prototype.watch
    return options.watch && hasProperty(options, "watch");
}
/** @internal */
export function closeFileWatcher(watcher) {
    watcher.close();
}
/** @internal */
export function getCheckFlags(symbol) {
    return symbol.flags & SymbolFlags.Transient ? symbol.links.checkFlags : 0;
}
/** @internal */
export function getDeclarationModifierFlagsFromSymbol(s, isWrite = false) {
...
/** @internal */
export function skipAlias(symbol, checker) {
 ...
 * @internal
 */
export function getCombinedLocalAndExportSymbolFlags(symbol) {
...
function accessKind(node) {
    ...
    switch (parent === null || parent === void 0 ? void 0 : parent.kind) {
        ...
        case SyntaxKind.PrefixUnaryExpression:
            ...
            return operator === SyntaxKind.PlusPlusToken || operator === SyntaxKind.MinusMinusToken ? 2 /* AccessKind.ReadWrite */ : 0 /* AccessKind.Read */;
        case SyntaxKind.BinaryExpression:
            const { left, operatorToken } = parent;
            return left === node && isAssignmentOperator(operatorToken.kind) ?
                operatorToken.kind === SyntaxKind.EqualsToken ? 1 /* AccessKind.Write */ : 2 /* AccessKind.ReadWrite */
                : 0 /* AccessKind.Read */;
        case SyntaxKind.PropertyAccessExpression:
        ...
        case SyntaxKind.ForInStatement:
        case SyntaxKind.ForOfStatement:
            return node === parent.initializer ? 1 /* AccessKind.Write */ : 0 /* AccessKind.Read */;
        default:
...
/** @internal */
export function compareDataObjects(dst, src) {
 ...
 * @internal
 */
export function clearMap(map, onDeleteValue) {
    // Remove all
    map.forEach(onDeleteValue);
    map.clear();
}
export function mutateMapSkippingNewValues(map, newMap, options) {
    const { onDeleteValue, onExistingValue } = options;
    // Needs update
    map.forEach((existingValue, key) => {
        var _a, _b;
        // Not present any more in new map, remove it
        if (!(newMap === null || newMap === void 0 ? void 0 : newMap.has(key))) {
            map.delete(key);
            onDeleteValue(existingValue, key);
        }
        // If present notify about existing values
        else if (onExistingValue) {
            onExistingValue(existingValue, (_b = (_a = newMap).get) === null || _b === void 0 ? void 0 : _b.call(_a, key), key);
        }
    });
}
export function mutateMap(map, newMap, options) {
    // Needs update
    mutateMapSkippingNewValues(map, newMap, options);
    const { createNewValue } = options;
    // Add new values that are not already present
    newMap === null || newMap === void 0 ? void 0 : newMap.forEach((valueInNewMap, key) => {
        if (!map.has(key)) {
            // New values
...
/** @internal */
export function isAbstractConstructorSymbol(symbol) {
...
/** @internal */
export function getClassLikeDeclarationOfSymbol(symbol) {
    var _a;
    return (_a = symbol.declarations) === null || _a === void 0 ? void 0 : _a.find(isClassLike);
}
/** @internal */
export function getObjectFlags(type) {
    return type.flags & TypeFlags.ObjectFlagsType ? type.objectFlags : 0;
}
/** @internal */
export function isUMDExportSymbol(symbol) {
    return !!symbol && !!symbol.declarations && !!symbol.declarations[0] && isNamespaceExportDeclaration(symbol.declarations[0]);
}
/** @internal */
export function showModuleSpecifier({ moduleSpecifier }) {
 ...
 * @internal
 */
export function addToSeen(seen, key) {
    if (seen.has(key)) {
        return false;
    }
    seen.add(key);
...
/** @internal */
export function getNameOfAccessExpression(node) {
...
/** @internal */
export function forEachNameInAccessChainWalkingLeft(name, action) {
...
/** @internal */
export function createFileDiagnostic(file, start, length, message, ...args) {
    assertDiagnosticLocation(file.text, start, length);
    let text = getLocaleSpecificMessage(message);
    if (some(args)) {
        text = formatStringFromArgs(text, args);
...
/** @internal */
export function createCompilerDiagnostic(message, ...args) {
    let text = getLocaleSpecificMessage(message);
    if (some(args)) {
        text = formatStringFromArgs(text, args);
    }
...
/** @internal */
export function createCompilerDiagnosticFromMessageChain(chain, relatedInformation) {
    return {
        file: undefined,
        start: undefined,
        length: undefined,
...
/** @internal */
export function chainDiagnosticMessages(details, message, ...args) {
    let text = getLocaleSpecificMessage(message);
    if (some(args)) {
        text = formatStringFromArgs(text, args);
    }
...
/** @internal */
export function concatenateDiagnosticMessageChains(headChain, tailChain) {
...
/** @internal */
export function diagnosticsEqualityComparer(d1, d2) {
    const code1 = getDiagnosticCode(d1);
    const code2 = getDiagnosticCode(d2);
...
function getDiagnosticCode(d) {
    var _a;
    return ((_a = d.canonicalHead) === null || _a === void 0 ? void 0 : _a.code) || d.code;
}
function getDiagnosticMessage(d) {
    var _a;
    return ((_a = d.canonicalHead) === null || _a === void 0 ? void 0 : _a.messageText) || d.messageText;
}
...
/** @internal */
export function getSetExternalModuleIndicator(options) {
...
const _computedOptions = createComputedCompilerOptions({
    ...
    target: {
        ...
        computeValue: compilerOptions => {
            ...
            return target !== null && target !== void 0 ? target : ((compilerOptions.module === ModuleKind.Node16 && ScriptTarget.ES2022) ||
...
/** @internal */
export const computedOptions = _computedOptions;
/** @internal */
export const getAllowImportingTsExtensions = _computedOptions.allowImportingTsExtensions.computeValue;
/** @internal */
export const getEmitScriptTarget = _computedOptions.target.computeValue;
/** @internal */
export const getEmitModuleKind = _computedOptions.module.computeValue;
/** @internal */
export const getEmitModuleResolutionKind = _computedOptions.moduleResolution.computeValue;
/** @internal @knipignore */
export const getEmitModuleDetectionKind = _computedOptions.moduleDetection.computeValue;
/** @internal */
export const getIsolatedModules = _computedOptions.isolatedModules.computeValue;
/** @internal */
export const getESModuleInterop = _computedOptions.esModuleInterop.computeValue;
/** @internal */
export const getAllowSyntheticDefaultImports = _computedOptions.allowSyntheticDefaultImports.computeValue;
/** @internal */
export const getResolvePackageJsonExports = _computedOptions.resolvePackageJsonExports.computeValue;
/** @internal */
export const getResolvePackageJsonImports = _computedOptions.resolvePackageJsonImports.computeValue;
/** @internal */
export const getResolveJsonModule = _computedOptions.resolveJsonModule.computeValue;
/** @internal */
export const getEmitDeclarations = _computedOptions.declaration.computeValue;
/** @internal */
export const shouldPreserveConstEnums = _computedOptions.preserveConstEnums.computeValue;
/** @internal */
export const isIncrementalCompilation = _computedOptions.incremental.computeValue;
/** @internal */
export const getAreDeclarationMapsEnabled = _computedOptions.declarationMap.computeValue;
/** @internal */
export const getAllowJSCompilerOption = _computedOptions.allowJs.computeValue;
/** @internal */
export const getUseDefineForClassFields = _computedOptions.useDefineForClassFields.computeValue;
/** @internal */
export function emitModuleKindIsNonNodeESM(moduleKind) {
    return moduleKind >= ModuleKind.ES2015 && moduleKind <= ModuleKind.ESNext;
}
/** @internal */
export function hasJsonModuleEmitEnabled(options) {
...
/** @internal */
export function unreachableCodeIsError(options) {
    return options.allowUnreachableCode === false;
}
/** @internal */
export function unusedLabelIsError(options) {
...
export function getJSXImplicitImportBase(compilerOptions, file) {
    const jsxImportSourcePragmas = file === null || file === void 0 ? void 0 : file.pragmas.get("jsximportsource");
    ...
    const jsxRuntimePragmas = file === null || file === void 0 ? void 0 : file.pragmas.get("jsxruntime");
    const jsxRuntimePragma = isArray(jsxRuntimePragmas) ? jsxRuntimePragmas[jsxRuntimePragmas.length - 1] : jsxRuntimePragmas;
    if ((jsxRuntimePragma === null || jsxRuntimePragma === void 0 ? void 0 : jsxRuntimePragma.arguments.factory) === "classic") {
        return undefined;
    }
    return compilerOptions.jsx === JsxEmit.ReactJSX ||
        ...
        (jsxRuntimePragma === null || jsxRuntimePragma === void 0 ? void 0 : jsxRuntimePragma.arguments.factory) === "automatic" ?
...
/** @internal */
export function createSymlinkCache(cwd, getCanonicalFileName) {
    ...
    function hasAnySymlinks() {
        return !!(symlinkedFiles === null || symlinkedFiles === void 0 ? void 0 : symlinkedFiles.size) || (!!symlinkedDirectories && !!forEachEntry(symlinkedDirectories, value => !!value));
    }
...
/** @internal */
export function tryRemoveDirectoryPrefix(path, dirPath, getCanonicalFileName) {
...
/** @internal */
export function getRegularExpressionForWildcard(specs, basePath, usage) {
...
/** @internal */
export function getRegularExpressionsForWildcards(specs, basePath, usage) {
...
/** @internal */
export function getPatternFromSpec(spec, basePath, usage) {
    const pattern = spec && getSubPatternFromSpec(spec, basePath, usage, wildcardMatchers[usage]);
    return pattern && `^(${pattern})${usage === "exclude" ? "($|/)" : "$"}`;
}
/** @internal */
export function getSubPatternFromSpec(spec, basePath, usage, { singleAsteriskRegexFragment, doubleAsteriskRegexFragment, replaceWildcardCharacter } = wildcardMatchers[usage]) {
    let subpattern = "";
 ...
 * @internal
 */
export function getFileMatcherPatterns(path, excludes, includes, useCaseSensitiveFileNames, currentDirectory) {
...
/** @internal */
export function getRegexFromPattern(pattern, useCaseSensitiveFileNames) {
 ...
 * @internal
 */
export function matchFiles(path, extensions, excludes, includes, useCaseSensitiveFileNames, currentDirectory, depth, getFileSystemEntries, realpath) {
    path = normalizePath(path);
    currentDirectory = normalizePath(currentDirectory);
...
/** @internal */
export function ensureScriptKind(fileName, scriptKind) {
 ...
 */
const supportedTSExtensions = [[Extension.Ts, Extension.Tsx, Extension.Dts], [Extension.Cts, Extension.Dcts], [Extension.Mts, Extension.Dmts]];
/** @internal */
export const supportedTSExtensionsFlat = flatten(supportedTSExtensions);
const supportedTSExtensionsWithJson = [...supportedTSExtensions, [Extension.Json]];
/** Must have ".d.ts" first because if ".ts" goes first, that will be detected as the extension instead of ".d.ts". */
const supportedTSExtensionsForExtractExtension = [Extension.Dts, Extension.Dcts, Extension.Dmts, Extension.Cts, Extension.Mts, Extension.Ts, Extension.Tsx];
const supportedJSExtensions = [[Extension.Js, Extension.Jsx], [Extension.Mjs], [Extension.Cjs]];
/** @internal */
export const supportedJSExtensionsFlat = flatten(supportedJSExtensions);
const allSupportedExtensions = [[Extension.Ts, Extension.Tsx, Extension.Dts, Extension.Js, Extension.Jsx], [Extension.Cts, Extension.Dcts, Extension.Cjs], [Extension.Mts, Extension.Dmts, Extension.Mjs]];
const allSupportedExtensionsWithJson = [...allSupportedExtensions, [Extension.Json]];
/** @internal */
export const supportedDeclarationExtensions = [Extension.Dts, Extension.Dcts, Extension.Dmts];
/** @internal */
export const supportedTSImplementationExtensions = [Extension.Ts, Extension.Cts, Extension.Mts, Extension.Tsx];
/** @internal */
export const extensionsNotSupportingExtensionlessResolution = [Extension.Mts, Extension.Dmts, Extension.Mjs, Extension.Cts, Extension.Dcts, Extension.Cjs];
/** @internal */
export function getSupportedExtensions(options, extraFileExtensions) {
    ...
    const extensions = [
        ...builtins,
        ...mapDefined(extraFileExtensions, x => x.scriptKind === ScriptKind.Deferred || needJsExtensions && isJSLike(x.scriptKind) && !flatBuiltins.includes(x.extension) ? [x.extension] : undefined),
    ];
    return extensions;
}
/** @internal */
export function getSupportedExtensionsWithJsonIfResolveJsonModule(options, supportedExtensions) {
 ...
 */
export var ModuleSpecifierEnding;
(function (ModuleSpecifierEnding) {
    ModuleSpecifierEnding[ModuleSpecifierEnding["Minimal"] = 0] = "Minimal";
    ModuleSpecifierEnding[ModuleSpecifierEnding["Index"] = 1] = "Index";
    ModuleSpecifierEnding[ModuleSpecifierEnding["JsExtension"] = 2] = "JsExtension";
    ModuleSpecifierEnding[ModuleSpecifierEnding["TsExtension"] = 3] = "TsExtension";
})(ModuleSpecifierEnding || (ModuleSpecifierEnding = {}));
function usesExtensionsOnImports({ imports }, hasExtension = or(hasJSFileExtension, hasTSFileExtension)) {
...
/** @internal */
export function getModuleSpecifierEndingPreference(preference, resolutionMode, compilerOptions, sourceFile) {
    ...
    if (!shouldAllowImportingTsExtension(compilerOptions)) {
        ...
        return sourceFile && usesExtensionsOnImports(sourceFile) ? 2 /* ModuleSpecifierEnding.JsExtension */ : 0 /* ModuleSpecifierEnding.Minimal */;
    }
    return inferPreference();
    function inferPreference() {
        let usesJsExtensions = false;
        const specifiers = (sourceFile === null || sourceFile === void 0 ? void 0 : sourceFile.imports.length) ? sourceFile.imports :
...
/** @internal */
export function isSupportedSourceFileName(fileName, compilerOptions, extraFileExtensions) {
    if (!fileName)
        return false;
...
/** @internal @knipignore */
export function tryRemoveExtension(path, extension) {
...
const parsedPatternsCache = new WeakMap();
/**
 ...
 * @internal
 */
export function tryParsePatterns(paths) {
    ...
    for (const path of pathList) {
        ...
        if (patternOrStr === undefined) {
            ...
            (matchableStringSet !== null && matchableStringSet !== void 0 ? matchableStringSet : (matchableStringSet = new Set())).add(patternOrStr);
        }
        else {
            (patterns !== null && patterns !== void 0 ? patterns : (patterns = [])).push(patternOrStr);
        }
    }
...
/** @internal */
export function isAnySupportedFileExtension(path) {
    return tryGetExtensionFromPath(path) !== undefined;
}
/** @internal */
export function tryGetExtensionFromPath(path) {
 ...
 * @internal
 */
export function matchPatternOrExact(parsedPatterns, candidate) {
    const { matchableStringSet, patterns } = parsedPatterns;
    if (matchableStringSet === null || matchableStringSet === void 0 ? void 0 : matchableStringSet.has(candidate)) {
        return candidate;
    }
...
/** @internal */
export function sliceAfter(arr, value) {
    const index = arr.indexOf(value);
    Debug.assert(index !== -1);
    return arr.slice(index);
}
/** @internal */
export function addRelatedInfo(diagnostic, ...relatedInformation) {
...
/** @internal */
export function minAndMax(arr, getValue) {
...
/** @internal */
export function skipTypeChecking(sourceFile, options, host) {
    return skipTypeCheckingWorker(sourceFile, options, host, /*ignoreNoCheck*/ false);
}
/** @internal */
export function skipTypeCheckingIgnoringNoCheck(sourceFile, options, host) {
...
/** @internal */
export function canIncludeBindAndCheckDiagnostics(sourceFile, options) {
...
/** @internal */
export function pseudoBigIntToString({ negative, base10Value }) {
    return (negative && base10Value !== "0" ? "-" : "") + base10Value;
}
/** @internal */
export function parseBigInt(text) {
...
function isIdentifierInNonEmittingHeritageClause(node) {
    ...
    return (heritageClause === null || heritageClause === void 0 ? void 0 : heritageClause.token) === SyntaxKind.ImplementsKeyword || (heritageClause === null || heritageClause === void 0 ? void 0 : heritageClause.parent.kind) === SyntaxKind.InterfaceDeclaration;
}
/** @internal */
...
/** @internal */
export function arrayIsHomogeneous(array, comparer = equateValues) {
    if (array.length < 2)
        return true;
    const first = array[0];
 ...
 * @internal
 */
export function setTextRangePos(range, pos) {
    range.pos = pos;
    return range;
}
/**
 ...
 * @internal
 */
export function setTextRangeEnd(range, end) {
    range.end = end;
    return range;
}
/**
 ...
 * @internal
 */
export function setTextRangePosEnd(range, pos, end) {
 ...
 * @internal
 */
export function setTextRangePosWidth(range, pos, width) {
    return setTextRangePosEnd(range, pos, pos + width);
}
/** @internal */
export function setNodeFlags(node, newFlags) {
    if (node) {
        node.flags = newFlags;
    }
    return node;
...
/** @internal */
export function setParentRecursive(rootNode, incremental) {
    if (!rootNode)
        return rootNode;
 ...
 * @internal
 */
export function isPackedArrayLiteral(node) {
...
export function getContainingNodeArray(node) {
    ...
    switch (parent.kind) {
        ...
        case SyntaxKind.ClassDeclaration:
        case SyntaxKind.ClassExpression:
            return isClassElement(node) ? parent.members : undefined;
        case SyntaxKind.EnumDeclaration:
...
/** @internal */
export function isCatchClauseVariableDeclaration(node) {
    return node.kind === SyntaxKind.VariableDeclaration && node.parent.kind === SyntaxKind.CatchClause;
}
/** @internal */
...
/** @internal */
export function createPropertyNameNodeForIdentifierOrLiteral(name, target, singleQuote, stringNamed, isMethod) {
...
/** @internal */
export function isThisTypeParameter(type) {
    return !!(type.flags & TypeFlags.TypeParameter && type.isThisType);
}
/** @internal */
export function getNodeModulePathParts(fullPath) {
    ...
    let partStart = 0;
    let partEnd = 0;
    let state = 0 /* States.BeforeNodeModules */;
    while (partEnd >= 0) {
        partStart = partEnd;
    ...
    return state > 1 /* States.NodeModules */ ? { topLevelNodeModulesIndex, topLevelPackageNameIndex, packageRootIndex, fileNameIndex } : undefined;
}
/** @internal */
...
/** @internal */
export function canHaveExportModifier(node) {
...
/** @internal */
export function isOptionalJSDocPropertyLikeTag(node) {
...
/** @internal */
export function canUsePropertyAccess(name, languageVersion) {
    if (name.length === 0) {
        return false;
    }
...
/** @internal */
export function hasTabstop(node) {
    var _a;
    return ((_a = getSnippetElement(node)) === null || _a === void 0 ? void 0 : _a.kind) === SnippetKind.TabStop;
}
/** @internal */
...
export function isNonNullAccess(node) {
    ...
    return (kind === SyntaxKind.PropertyAccessExpression
        || kind === SyntaxKind.ElementAccessExpression) && isNonNullExpression(node.expression);
}
/** @internal */
export function isJSDocSatisfiesExpression(node) {
    return isInJSFile(node) && isParenthesizedExpression(node) && hasJSDocNodes(node) && !!getJSDocSatisfiesTag(node);
}
/** @internal */
export function getJSDocSatisfiesExpressionType(node) {
    return Debug.checkDefined(tryGetJSDocSatisfiesTypeNode(node));
}
/** @internal */
export function tryGetJSDocSatisfiesTypeNode(node) {
    const tag = getJSDocSatisfiesTag(node);
    return tag && tag.typeExpression && tag.typeExpression.type;
}
/** @internal */
export function getEscapedTextOfJsxAttributeName(node) {
    return isIdentifier(node) ? node.escapedText : getEscapedTextOfJsxNamespacedName(node);
}
/** @internal */
export function getTextOfJsxAttributeName(node) {
...
/** @internal */
export function getEscapedTextOfJsxNamespacedName(node) {
    return `${node.namespace.escapedText}:${idText(node.name)}`;
}
/** @internal */
export function getTextOfJsxNamespacedName(node) {
    return `${idText(node.namespace)}:${idText(node.name)}`;
}
/** @internal */
export function intrinsicTagNameToString(node) {
    return isIdentifier(node) ? idText(node) : getTextOfJsxNamespacedName(node);
}
/**
 ...
 * @internal
 */
export function isTypeUsableAsPropertyName(type) {
 ...
 * @internal
 */
export function getPropertyNameFromType(type) {
...
/** @internal */
export function isExpandoPropertyDeclaration(declaration) {
...
/** @internal */
export function getNameFromImportAttribute(node) {
...
/** @internal */
export function evaluatorResult(value, isSyntacticallyString = false, resolvedOtherFiles = false, hasExternalReferences = false) {
    return { value, isSyntacticallyString, resolvedOtherFiles, hasExternalReferences };
}
/** @internal */
export function createEvaluator({ evaluateElementAccessExpression, evaluateEntityNameExpression }) {
    function evaluate(expr, location) {
        ...
        switch (expr.kind) {
            ...
            case SyntaxKind.BinaryExpression: {
                ...
                isSyntacticallyString = (left.isSyntacticallyString || right.isSyntacticallyString) && expr.operatorToken.kind === SyntaxKind.PlusToken;
                ...
                if (typeof left.value === "number" && typeof right.value === "number") {
                    switch (expr.operatorToken.kind) {
                        ...
                        case SyntaxKind.PercentToken:
                            return evaluatorResult(left.value % right.value, isSyntacticallyString, resolvedOtherFiles, hasExternalReferences);
                        case SyntaxKind.AsteriskAsteriskToken:
                            return evaluatorResult(Math.pow(left.value, right.value), isSyntacticallyString, resolvedOtherFiles, hasExternalReferences);
                    }
                }
                else if ((typeof left.value === "string" || typeof left.value === "number") &&
                    (typeof right.value === "string" || typeof right.value === "number") &&
                    expr.operatorToken.kind === SyntaxKind.PlusToken) {
                    return evaluatorResult("" + left.value + right.value, isSyntacticallyString, resolvedOtherFiles, hasExternalReferences);
                }
                break;
            }
            case SyntaxKind.StringLiteral:
            case SyntaxKind.NoSubstitutionTemplateLiteral:
                return evaluatorResult(expr.text, /*isSyntacticallyString*/ true);
            case SyntaxKind.TemplateExpression:
    ...
    function evaluateTemplateExpression(expr, location) {
        ...
        /*isSyntacticallyString*/ true, resolvedOtherFiles, hasExternalReferences);
    }
    return evaluate;
}
/** @internal */
export function isConstAssertion(location) {
...
/** @internal */
export function createNameResolver({ compilerOptions, requireSymbol, argumentsSymbol, error, getSymbolOfDeclaration, globals, lookup, setRequiresScopeChangeCache = returnUndefined, getRequiresScopeChangeCache = returnUndefined, onPropertyWithInvalidInitializer = returnFalse, onFailedToResolveSymbol = returnUndefined, onSuccessfullyResolvedSymbol = returnUndefined, }) {
    /* eslint-disable no-var */
    ...
    function resolveNameHelper(location, nameArg, meaning, nameNotFoundMessage, isUse, excludeGlobals) {
        ...
        loop: while (location) {
            ...
            switch (location.kind) {
                ...
                // falls through
                case SyntaxKind.ModuleDeclaration:
                    const moduleExports = ((_a = getSymbolOfDeclaration(location)) === null || _a === void 0 ? void 0 : _a.exports) || emptySymbols;
                    ...
                    if (name !== InternalSymbolName.Default && (result = lookup(moduleExports, name, meaning & SymbolFlags.ModuleMember))) {
                        if (isSourceFile(location) && location.commonJsModuleIndicator && !((_b = result.declarations) === null || _b === void 0 ? void 0 : _b.some(isJSDocTypeAlias))) {
                            result = undefined;
                        }
                        else {
                            break loop;
                    ...
                    break;
                case SyntaxKind.EnumDeclaration:
                    if (result = lookup(((_c = getSymbolOfDeclaration(location)) === null || _c === void 0 ? void 0 : _c.exports) || emptySymbols, name, meaning & SymbolFlags.EnumMember)) {
                        if (nameNotFoundMessage && getIsolatedModules(compilerOptions) && !(location.flags & NodeFlags.Ambient) && getSourceFileOfNode(location) !== getSourceFileOfNode(result.valueDeclaration)) {
                            error(originalLocation, Diagnostics.Cannot_access_0_from_another_file_without_qualification_when_1_is_enabled_Use_2_instead, unescapeLeadingUnderscores(name), isolatedModulesLikeFlagName, `${unescapeLeadingUnderscores(getSymbolOfDeclaration(location).escapedName)}.${unescapeLeadingUnderscores(name)}`);
                        }
                        break loop;
                    }
                    break;
                ...
                case SyntaxKind.InterfaceDeclaration:
                    ...
                    if (result = lookup(getSymbolOfDeclaration(location).members || emptySymbols, name, meaning & SymbolFlags.Type)) {
                ...
                case SyntaxKind.ComputedPropertyName:
                    ...
                    if (isClassLike(grandparent) || grandparent.kind === SyntaxKind.InterfaceDeclaration) {
                        ...
                        if (result = lookup(getSymbolOfDeclaration(grandparent).members, name, meaning & SymbolFlags.Type)) {
                            if (nameNotFoundMessage) {
                ...
                case SyntaxKind.Parameter:
                    if (lastLocation && (lastLocation === location.initializer ||
                        lastLocation === location.name && isBindingPattern(lastLocation))) {
    ...
    function getIsDeferredContext(location, lastLocation) {
        if (location.kind !== SyntaxKind.ArrowFunction && location.kind !== SyntaxKind.FunctionExpression) {
            ...
            return isTypeQueryNode(location) || ((isFunctionLikeDeclaration(location) ||
                (location.kind === SyntaxKind.PropertyDeclaration && !isStatic(location))) && (!lastLocation || lastLocation !== location.name)); // A name is evaluated within the enclosing scope - so it shouldn't count as deferred
        }
        if (lastLocation && lastLocation === location.name) {
            return false;
        }
        // generator functions and async functions are not inlined in control flow when immediately invoked
        if (location.asteriskToken || hasSyntacticModifier(location, ModifierFlags.Async)) {
            return true;
        }
...
/** @internal */
export function isPrimitiveLiteralValue(node, includeBigInt = true) {
    Debug.type(node);
    switch (node.kind) {
        case SyntaxKind.TrueKeyword:
        case SyntaxKind.FalseKeyword:
...
/** @internal */
export function isNewScopeNode(node) {
    return isFunctionLike(node)
        || isJSDocSignature(node)
        || isMappedTypeNode(node);
}
/** @internal */
export function getLibNameFromLibReference(libReference) {
    return toFileNameLowerCase(libReference.fileName);
}
/** @internal */
export function getLibFileNameFromLibReference(libReference) {
    const libName = getLibNameFromLibReference(libReference);
    return libMap.get(libName);
}
/** @internal */
export function forEachResolvedProjectReference(resolvedProjectReferences, cb) {
    return forEachProjectReference(
    /*projectReferences*/ undefined, resolvedProjectReferences, (resolvedRef, parent) => resolvedRef && cb(resolvedRef, parent));
}
/** @internal */
export function forEachProjectReference(projectReferences, resolvedProjectReferences, cbResolvedRef, cbRef) {
    ...
    function worker(projectReferences, resolvedProjectReferences, parent) {
        ...
        return forEach(resolvedProjectReferences, (resolvedRef, index) => {
            if (resolvedRef && (seenResolvedRefs === null || seenResolvedRefs === void 0 ? void 0 : seenResolvedRefs.has(resolvedRef.sourceFile.path))) {
                (skipChildren !== null && skipChildren !== void 0 ? skipChildren : (skipChildren = new Set())).add(resolvedRef);
                // ignore recursives
                return undefined;
            }
        ...
        }) || forEach(resolvedProjectReferences, resolvedRef => resolvedRef && !(skipChildren === null || skipChildren === void 0 ? void 0 : skipChildren.has(resolvedRef)) ?
            worker(resolvedRef.commandLine.projectReferences, resolvedRef.references, resolvedRef) :
            undefined);
    }
}
/** @internal */
export function getOptionsSyntaxByArrayElementValue(optionsObject, name, value) {
...
/** @internal */
export function getOptionsSyntaxByValue(optionsObject, name, value) {
...
/** @internal */
export function forEachOptionsSyntaxByName(optionsObject, name, callback) {
