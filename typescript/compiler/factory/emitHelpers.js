...
/** @internal */
export function createEmitHelperFactory(context) {
    ...
    function createESDecorateClassElementAccessHasMethod(elementName) {
        ...
        /*typeParameters*/ undefined, [factory.createParameterDeclaration(
            ...
            /*dotDotDotToken*/ undefined, factory.createIdentifier("obj"))], 
        /*type*/ undefined, 
        /*equalsGreaterThanToken*/ undefined, factory.createBinaryExpression(propertyName, SyntaxKind.InKeyword, factory.createIdentifier("obj"))));
    }
    ...
    function createAwaiterHelper(hasLexicalThis, argumentsExpression, promiseConstructor, parameters, body) {
        ...
        /*name*/ undefined, 
        /*typeParameters*/ undefined, parameters !== null && parameters !== void 0 ? parameters : [], 
        /*type*/ undefined, body);
        // Mark this node as originally an async function
        (generatorFunc.emitNode || (generatorFunc.emitNode = {})).flags |= EmitFlags.AsyncFunctionBody | EmitFlags.ReuseTempVariableScope;
        ...
        /*typeArguments*/ undefined, [
            hasLexicalThis ? factory.createThis() : factory.createVoidZero(),
            argumentsExpression !== null && argumentsExpression !== void 0 ? argumentsExpression : factory.createVoidZero(),
    ...
    function createExportStarHelper(moduleExpression, exportsExpression = factory.createIdentifier("exports")) {
    ...
    function createAddDisposableResourceHelper(envBinding, value, async) {
        ...
        return factory.createCallExpression(getUnscopedHelperName("__addDisposableResource"), 
        /*typeArguments*/ undefined, [envBinding, value, async ? factory.createTrue() : factory.createFalse()]);
    }
    ...
    function createRewriteRelativeImportExtensionsHelper(expression) {
        ...
        return factory.createCallExpression(getUnscopedHelperName("__rewriteRelativeImportExtension"), 
        /*typeArguments*/ undefined, context.getCompilerOptions().jsx === JsxEmit.Preserve
 ...
 *      NOTE: This always results in a runtime error.
 */
const classPrivateFieldSetHelper = {
...
const addDisposableResourceHelper = {
...
const rewriteRelativeImportExtensionsHelper = {
...
/** @internal */
export function isCallToHelper(firstSegment, helperName) {
