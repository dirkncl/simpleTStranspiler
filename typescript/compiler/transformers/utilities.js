...
/** @internal */
export function getOriginalNodeId(node) {
...
/** @internal */
export function chainBundle(context, transformSourceFile) {
...
/** @internal */
export function collectExternalModuleInfo(context, sourceFile) {
    ...
    for (const node of sourceFile.statements) {
        switch (node.kind) {
            ...
            case SyntaxKind.FunctionDeclaration:
                if (hasSyntacticModifier(node, ModifierFlags.Export)) {
                    addExportedFunctionDeclaration(node, /*name*/ undefined, hasSyntacticModifier(node, ModifierFlags.Default));
                }
                break;
    ...
    function addExportedFunctionDeclaration(node, name, isDefault) {
        ...
        if (isDefault) {
            ...
            if (!hasExportDefault) {
                multiMapSparseArrayAdd(exportedBindings, getOriginalNodeId(node), name !== null && name !== void 0 ? name : context.factory.getDeclarationName(node));
                hasExportDefault = true;
            }
        }
        else {
            // export function x() { }
            // function x() { } + export { x }
            name !== null && name !== void 0 ? name : (name = node.name);
            const nameText = moduleExportNameTextUnescaped(name);
            if (!uniqueExports.get(nameText)) {
                multiMapSparseArrayAdd(exportedBindings, getOriginalNodeId(node), name);
                uniqueExports.set(nameText, true);
...
/** @internal */
export class IdentifierNameMap {
    constructor() {
        this._map = new Map();
    }
    get size() {
    ...
    delete(key) {
        var _a, _b;
        return (_b = (_a = this._map) === null || _a === void 0 ? void 0 : _a.delete(IdentifierNameMap.toKey(key))) !== null && _b !== void 0 ? _b : false;
    }
    clear() {
        this._map.clear();
    }
...
class IdentifierNameMultiMap extends IdentifierNameMap {
    add(key, value) {
...
/** @internal */
export function isCompoundAssignment(kind) {
...
/** @internal */
export function getProperties(node, requireInitializer, isStatic) {
...
/** @internal */
export function getStaticPropertiesAndClassStaticBlock(node) {
    ...
    switch (member.kind) {
        ...
        case SyntaxKind.SetAccessor:
            if (!useLegacyDecorators) {
                return getAllDecoratorsOfMethod(member, /*useLegacyDecorators*/ false);
            }
            return getAllDecoratorsOfAccessors(member, parent, /*useLegacyDecorators*/ true);
...
/** @internal */
export function newPrivateEnvironment(data) {
    return { data };
}
/** @internal */
export function getPrivateIdentifier(privateEnv, name) {
    var _a, _b;
    return isGeneratedPrivateIdentifier(name) ?
        (_a = privateEnv === null || privateEnv === void 0 ? void 0 : privateEnv.generatedIdentifiers) === null || _a === void 0 ? void 0 : _a.get(getNodeForGeneratedName(name)) :
        (_b = privateEnv === null || privateEnv === void 0 ? void 0 : privateEnv.identifiers) === null || _b === void 0 ? void 0 : _b.get(name.escapedText);
}
/** @internal */
export function setPrivateIdentifier(privateEnv, name, entry) {
    var _a, _b;
...
/** @internal */
export function accessPrivateIdentifier(env, name) {
...
/** @internal */
export function isSimpleParameterList(nodes) {
    return every(nodes, isSimpleParameter);
}
/** @internal */
export function rewriteModuleSpecifier(node, compilerOptions) {
