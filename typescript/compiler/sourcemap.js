...
export function createSourceMapGenerator(host, file, sourceRoot, sourcesDirectoryPath, generatorOptions) {
    ...
    var sourcesContent; // eslint-disable-line no-restricted-syntax
    var names = [];
...
/** @internal */
export function getLineInfo(text, lineStarts) {
    return {
...
/* eslint-enable no-restricted-syntax */
/** @internal */
export function tryParseRawSourceMap(text) {
    try {
...
/** @internal */
export function sameMapping(left, right) {
    return left === right
...
/** @internal */
export function isSourceMapping(mapping) {
...
/** @internal */
export function createDocumentPositionMapper(host, map, mapPath) {
...
/** @internal */
export const identitySourceMapConsumer = {
