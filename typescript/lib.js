...
export const libFileSet = {};
libFileSet['lib.d.ts'] = true;
libFileSet['lib.decorators.d.ts'] = true;
libFileSet['lib.decorators.legacy.d.ts'] = true;
libFileSet['lib.dom.asynciterable.generated.d.ts'] = true;
libFileSet['lib.dom.generated.d.ts'] = true;
libFileSet['lib.dom.iterable.d.ts'] = true;
libFileSet['lib.dom.iterable.generated.d.ts'] = true;
libFileSet['lib.es2015.collection.d.ts'] = true;
libFileSet['lib.es2015.core.d.ts'] = true;
libFileSet['lib.es2015.d.ts'] = true;
libFileSet['lib.es2015.full.d.ts'] = true;
...
libFileSet['lib.es5.full.d.ts'] = true;
...
libFileSet['lib.header.d.ts'] = true;
libFileSet['lib.scripthost.d.ts'] = true;
libFileSet['lib.webworker.asynciterable.generated.d.ts'] = true;
libFileSet['lib.webworker.generated.d.ts'] = true;
libFileSet['lib.webworker.importscripts.d.ts'] = true;
libFileSet['lib.webworker.iterable.generated.d.ts'] = true;

export const libFileMap = {};

const path = new URL('./lib/', import.meta.url)

for(var k in libFileSet) {
  var k1ib = k.replace('lib.','') 
  libFileMap[k] = await (await fetch(path+k1ib)).text();
}
